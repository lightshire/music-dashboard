            ...
            content = (
                <div>
                    <div className='row col s12'>
                        ...
                        <div className='col s3 m3 toCenter'><a className='createHover' onClick={this.props.createArtistModal}><span className='modalCreate'><i className='large mdi-action-perm-identity'></i></span><span>Artist</span></a></div>
                        <div className='col s3 m3 toCenter'><a className='createHover' onClick={this.props.createRecordLabelModal}><span className='modalCreate'><i className='large mdi-image-adjust'></i></span><span>Record Label</span></a></div>
                    </div>
                </div>
            );
