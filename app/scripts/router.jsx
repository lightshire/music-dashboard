...
<<<<<<< HEAD
        <Route path='/' handler={Layout}>
            ...
            <Route name='admin' path='/admin' handler={Admin}>
                ...
                <Route name='admin.labels_earnings' path='/admin/record_labels_earnings' handler={AdminLabelsEarnings} />
                <Route name='admin.artists_earnings' path='/admin/artists_earnings' handler={AdminArtistEarnings} />
=======
...
>>>>>>> 0fd66fc927372dbcabec243f64b51e645ed437ec
            </Route>
